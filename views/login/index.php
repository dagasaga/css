...
<img src=<?php echo "'http://".WEBSITE_URL."/images/logo.png'"; ?> alt="logo" class="login_logo">
    ...
    <div id="content">
        ...
        <div class="login-card">
            <h1>Login</h1>
            <?php if (isset($output['login_form'])) echo $output['login_form']; ?>

            <?php if (isset($output['content'])) echo $output['content']; ?>

            <div class="login-help">
                <a href="?controller=users&action=register">Register</a> | <a href="?controller=users&action=forgot">Forgot Password</a>
            </div>
        </div>
    </div>
