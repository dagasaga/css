...
<div id="content">
    ...
    <div class="login-card">
        ...
        <?php if (isset($output['forgot_form'])) echo $output['forgot_form']; ?>

        <?php if (isset($output['content'])) echo $output['content']; ?>

        <div class="login-help">
            <a href="?controller=login&action=login">Login</a> | <a href="?controller=users&action=register">Register</a>
        </div>
    </div>
